...
import com.leonyr.permissionx.ClarityPotion.Companion.clarityPotion
import com.leonyr.permissionx.ClarityPotion.Companion.currentActivity
...
internal fun exec(request: Request) {
    when (val currentActivity = currentActivity()) {
        ...
        !is FragmentActivity -> resumeFailed(
            request,
