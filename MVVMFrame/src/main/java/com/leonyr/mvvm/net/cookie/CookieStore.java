...
public class CookieStore {
    ...
    protected String encodeCookie(OkHttpCookies cookie) {
        ...
        try {
            ...
            LogUtil.d(LOG_TAG, "IOException in encodeCookie"+  e.getMessage());
            return null;
        }
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            LogUtil.d(LOG_TAG, "IOException in decodeCookie" + e.getMessage());
        } catch (ClassNotFoundException e) {
            LogUtil.d(LOG_TAG, "ClassNotFoundException in decodeCookie" + e.getMessage());
        }
