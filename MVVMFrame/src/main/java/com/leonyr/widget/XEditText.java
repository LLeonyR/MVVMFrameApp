...
public class XEditText extends AppCompatEditText {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        allCaps = a.getBoolean(R.styleable.XEditText_x_allCaps, false);
    ...
    private void dealWithInputTypes(boolean fromXml) {
        ...
        if (isPwdInputType) {
            ...
            if (!disableClear) {
                mBitmap = getBitmapFromVectorDrawable(getContext(), mClearResId,
                        mClearResId == R.drawable.x_et_svg_ic_clear); // clearDrawable
            }
        }
        ...
        if (allCaps){
            setTransformationMethod(new AllCapTransformation());
        }
    }
    ...
    private class AllCapTransformation extends ReplacementTransformationMethod {
