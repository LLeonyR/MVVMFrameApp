...
public class PopupDialog extends Dialog{
    ...
    public void setBackgroundDraw(@DrawableRes int backgroundDraw) {
    ...
    private void configWindowBackground(Window window){
        if (backgroundDraw > 0){
            window.setBackgroundDrawable(getContext().getDrawable(backgroundDraw));
            return;
        }
        if(!mUseRadius){
