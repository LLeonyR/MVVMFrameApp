package com.leonyr.imageScan.extension.glide
...
object GlideHelper {
    ...
    fun downloadPicture(context: Context, url: String) : Job?{
        ...
        return CoroutineScope(SupervisorJob() + Dispatchers.IO).launch {
            var dFile = Glide.with(context).load(url).downloadOnly(Target.SIZE_ORIGINAL,
